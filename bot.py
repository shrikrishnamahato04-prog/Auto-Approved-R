...
# --- CONFIG VARS ---
# Heroku mein ADMINS naam ka variable banayein aur apni ID dalein
...
async def send_msg_with_media(client, chat_id, mention, title):
    ...
    # 5 Buttons Layout (1 Top, 2 Middle, 2 Bottom)
    ...
    try:
        ...
        # Agar bot blocked ho ya photo link expire ho jaye
        pass
...
async def main():
    ...
    await pr0fess0r_99.set_bot_commands([
        ...
        BotCommand("stats", "Check Stats (Admin) 📊"),
        BotCommand("broadcast", "Broadcast (Admin) 📢"),
        BotCommand("edit", "Edit Buttons (Admin) 🛠️")
    ])
